...
import { IMG_CARD_GRID_3, IMG_SPOTLIGHT_BENTO } from "@/lib/image-sizes";
            ...
            <BentoCard glowTone="amber">
              <div className="grid gap-0 sm:grid-cols-5">
                <div className="relative min-h-[260px] sm:col-span-2">
                  <Image src="/images/teacher.jpg" alt="Eğitmen" fill className="object-cover" sizes={IMG_SPOTLIGHT_BENTO} />
                </div>
          ...
          visible.map((c, idx) => {
            ...
            >
              <div className="relative h-40 bg-[var(--surface-muted)]">
                {c.cover_image_url ? (
                  <Image src={c.cover_image_url} alt="" fill className="object-cover" sizes={IMG_CARD_GRID_3} />
                ) : (
