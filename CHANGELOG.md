...
- **i18n:** Türkçe / English / Deutsch — `ob_locale` çerezi, `LocaleProvider`, nav + footer + auth + bülten + WhatsApp FAB çevirileri; `generateMetadata` ve `<html lang>` dil ile uyumlu.
